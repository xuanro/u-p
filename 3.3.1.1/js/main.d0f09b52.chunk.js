		...
		Hr = function(e) {
			...
			},
			{
				...
				value: function() {
					var e = this,
					t = this.props.classes,
					a = r.a.createElement("div", null, r.a.createElement(Br.a, null, "选择兑换方式："), r.a.createElement(Wr.a, {
						name: "spacing",
						"aria-label": "spacing",
					...
					!this.state.alipay && !this.state.payjs && 0 === this.state.value && ( - 1 === this.state.selectedPack || 0 === this.state.packs[this.state.selectedPack].score) && 1 === this.state.value && ( - 1 === this.state.selectedGroup || 0 === this.state.groups[this.state.selectedGroup].score) && r.a.createElement(B.a, null, "无可用支付方式"), this.state.alipay && r.a.createElement(Mn.a, {
						...
						control: r.a.createElement(zr.a, null),
						label: "积分兑换"
					})), r.a.createElement("div", null, 2 !== this.state.value && r.a.createElement(Br.a, null, "兑换时长倍数："), 2 === this.state.value && r.a.createElement(Br.a, null, "请查看：http://www.u-p.vip/pay")), 2 !== this.state.value && r.a.createElement(hn.a, {
					...
					r.a.createElement("div", null, "当前消耗：", "score" !== this.state.packPayMethod && r.a.createElement("span", {
						className: t.priceShow
					},
					"--", ), "score" === this.state.packPayMethod && r.a.createElement("span", {
						className: t.priceShow
					},
					...
					r.a.createElement(Cr.a, null), " 立即兑换")))))), 1 === this.state.value && r.a.createElement(U.a, {
						className: t.paper,
						square: !0
					},
					r.a.createElement(ja.a, {
					...
					"您所兑换的商品已到账。")), r.a.createElement(gn.a, null, r.a.createElement(V.a, {
						onClick: this.handleClose,
						color: "primary"
					},
					"关闭"))), r.a.createElement(Wa.a, {
					...
					"兑换用户组"), r.a.createElement(dn.a, null, r.a.createElement(Ur.a, {
						id: "alert-dialog-description"
					},
					"已选：", -1 !== this.state.selectedGroup && this.state.groups[this.state.selectedGroup].name), a, r.a.createElement("div", null, "当前消耗：", "score" !== this.state.packPayMethod && r.a.createElement("span", {
						className: t.priceShow
					},
					"--", ), "score" === this.state.packPayMethod && r.a.createElement("span", {
						className: t.priceShow

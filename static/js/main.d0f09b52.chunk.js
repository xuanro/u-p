			...
			},
			{
				...
				value: function() {
					...
					!this.state.alipay && !this.state.payjs && 0 === this.state.value && ( - 1 === this.state.selectedPack || 0 === this.state.packs[this.state.selectedPack].score) && 1 === this.state.value && ( - 1 === this.state.selectedGroup || 0 === this.state.groups[this.state.selectedGroup].score) && r.a.createElement(B.a, null, "\u65e0\u53ef\u7528\u652f\u4ed8\u65b9\u5f0f"), this.state.alipay && r.a.createElement(Mn.a, {
						...
						control: r.a.createElement(zr.a, null),
						label: "\u79ef\u5206\u652f\u4ed8"
					})), r.a.createElement("div", null, 2 !== this.state.value && r.a.createElement(Br.a, null, "\u8d2d\u4e70\u65f6\u957f\u500d\u6570\uff1a"), 2 === this.state.value && r.a.createElement(Br.a, null, "\u5145\u503c\u79ef\u5206\u6570\u91cf\uff1a")), 2 !== this.state.value && r.a.createElement(hn.a, {
					...
					"\uffe5", r.a.createElement("span", null, (this.state.scorePrice / 100 * this.state.scoreNum).toFixed(2)))), r.a.createElement("div", null, r.a.createElement(V.a, {
						size: "large",
						variant: "contained",
						color: "secondary",
						className: t.button,
						disabled: this.state.loading || null === this.state.packPayMethod,
						onClick: function() {
							return e.buyPack("score")
						}
					},
					r.a.createElement(Cr.a, null), " \u7acb\u5373\u8d2d\u4e70")))))), 3 === this.state.value && r.a.createElement(U.a, {
						className: t.paper,
						square: !0
					},
					r.a.createElement("div", {
